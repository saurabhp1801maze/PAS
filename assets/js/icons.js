/* Self-hosted inline SVG icon set (ported from the lucide-react icons used by the
   original React app). No network dependency. */
(function (global) {
  "use strict";
  ...
  var ICONS = {
    ...
    "stamp": '<path d="M5 22h14"/><path d="M12 17v-4"/><path d="M8 13V7a4 4 0 0 1 8 0v6"/><path d="M6 22a2 2 0 0 1-2-2v-3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v3a2 2 0 0 1-2 2Z"/>',
    ...
    "phone-call": '<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>',
    "send": '<path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/>'
  };

  PAS.ICONS = ICONS;

  /** Build an <svg> element for the named icon. opts: {size, color, className, strokeWidth} */
  PAS.icon = function (name, opts) {
    opts = opts || {};
  ...
  /** Same as PAS.icon but returns a markup string (for use inside template strings). */
  PAS.iconHtml = function (name, opts) {
    opts = opts || {};
    var size = opts.size || 14;
    return '<svg width="' + size + '" height="' + size + '" viewBox="0 0 24 24" fill="none" ' +
      'stroke="' + (opts.color || "currentColor") + '" stroke-width="' + (opts.strokeWidth || 2) +
      '" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;display:inline-block;vertical-align:middle" ' +
      (opts.className ? 'class="' + opts.className + '"' : "") + ">" + (ICONS[name] || "") + "</svg>";
  };
})(window);
