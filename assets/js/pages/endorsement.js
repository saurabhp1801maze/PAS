  ...
  function render() {
    ...
    var endorsementTable = ui.sortableTable({
      ...
      columns: [
        ...
        { key: "premiumImpact", label: "Premium impact", what: "Prorated delta from effective date to end of term.", sortValue: function (t) { return (t.h.meta && t.h.meta.premiumImpact) || 0; }, cell: function (t) { var impact = (t.h.meta && t.h.meta.premiumImpact) || 0; return ui.h("span", { style: { color: impact >= 0 ? "var(--color-success)" : "var(--color-danger)", fontWeight: "700" } }, (impact >= 0 ? "+" : "") + PAS.money(impact)); } },
